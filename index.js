...
const orderDetails = { userId: 'user-123', productIds: [1, 3], shippingInfo: '123 Main St', amount: 1235 };
...
const newLaptop = factory.createProduct('electronic', { id: 2, model: 'MacBook Pro', price: 2500 });
